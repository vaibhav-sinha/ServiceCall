...
import com.servicecall.app.event.MarkerClickEvent;
import com.servicecall.app.model.GoogleMapClusterItem;
...
public class GoogleMapFragment extends SupportMapFragment implements OnMapReadyCallback {
    ...
    */
    ...
    public void addCluster(List<ComplaintDto> complaintDtos) {
        clearMap();
        GoogleMapClusterItem googleMapCluster;
        LatLngBounds.Builder builder = new LatLngBounds.Builder();
        ClusterManager<GoogleMapClusterItem> mClusterManager;
        mClusterManager = new ClusterManager<GoogleMapClusterItem>(getActivity(), googleMap);
        googleMap.setOnCameraChangeListener(mClusterManager);
        googleMap.setOnMarkerClickListener(mClusterManager);
        for(ComplaintDto complaintDto : complaintDtos) {
            googleMapCluster = new GoogleMapClusterItem(complaintDto.getLattitude(), complaintDto.getLongitude());
