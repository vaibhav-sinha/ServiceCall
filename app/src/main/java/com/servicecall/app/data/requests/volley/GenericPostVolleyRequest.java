package com.servicecall.app.data.requests.volley;
...
public class GenericPostVolleyRequest<T> extends Request<String> {
    ...
    public String getBodyContentType() {
        Log.i("servicecall", "Content Type : " + entity.getContentType().getValue());
    ...
    protected Response<String> parseNetworkResponse(NetworkResponse response) {
        try {
            ...
            Log.i("servicecall", "json response = " + json);
    ...
    protected void deliverResponse(String response) {
        Log.i("servicecall", " response = " + response);
        if(mListener != null) {
